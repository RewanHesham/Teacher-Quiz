...
export function formatQuestion ({ questionText, optionOneText, optionTwoText, optionThreeText,  optionFourText, correctAnswerText, author }) {
  return {
    id: generateUID(),
    timestamp: Date.now(),
    author,
...
export function _saveQuestionAnswer ({ authedUser, qid, answer, correctAnswers }) {
  return new Promise((res, rej) => {
    setTimeout(() => {
      users = {
        ...users,
        [authedUser]: {
          ...
          correctAnswers: {
            ...users[authedUser].correctAnswers,
            correctAnswers
          },
        }
      }
