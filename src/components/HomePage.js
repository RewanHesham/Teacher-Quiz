        ...
        return (
          <div className="question-card">
            ...
            <div style={{color:"black"}}>
              {question.question.text} {" "} {question.optionOne.text} or{" "}
              {question.optionTwo.text} or{" "} 
              {question.optionThree.text} or{" "}
              {question.optionFour.text}?
            </div>
  ...
  render() {
    ...
    const [ unansweredQuestionsCount,
      ...
      id =>
        ...
        !questions[id].optionThree.votes.includes(authedUser) &&
        !questions[id].optionFour.votes.includes(authedUser)
    );
    ...
    const [answeredQuestionsCount,
      ...
      qid =>
        ...
        questions[qid].optionThree.votes.includes(authedUser) ||
        questions[qid].optionFour.votes.includes(authedUser)
    );
